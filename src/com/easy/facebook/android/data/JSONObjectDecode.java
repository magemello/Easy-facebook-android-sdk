...
public class JSONObjectDecode extends JSONArray {
	...
	public To getTo(int index) throws JSONException {
	...
	public Hometown getHometown(int index) throws JSONException {
	...
	public Location getLocation(int index) throws JSONException {
	...
	public School getSchool(int index) throws JSONException {
	...
	public Languages getLanguages(int index) throws JSONException {
	...
	public Position getPosition(int index) throws JSONException {
	...
	public Education getEducation(int index) throws JSONException {
	...
	public Work getWork(int index) throws JSONException {
	...
	public Employer getEmployer(int index) throws JSONException {
	...
	public Person getPerson(int index) throws JSONException {
	...
	public Feed getFeed(int index) throws JSONException {
	...
	public Home getHome(int index) throws JSONException {
	...
	public Events getEvent(int index) throws JSONException {
	...
	public Group getGroup(int index) throws JSONException {
	...
	public Album getAlbum(int index) throws JSONException {
	...
	public Message getMessage(int index) throws JSONException {
	...
	public Actions getActions(int index) throws JSONException {
		JSONObject json;
	...
	public Note getNote(int index) throws JSONException {
		JSONObject json;
	...
	public Page getPage(int index) throws JSONException {
	...
	public Tag getTag(int index) throws JSONException {
	...
	public Images getImages(int index) throws JSONException {
	...
	public Photo getPhoto(int index) throws JSONException {
	...
	public Checkin getCheckin(int index) throws JSONException {
		JSONObject json;
		...
		if (!json.isNull("location")) {
			...
			if (!locationJSON.isNull("street"))
				location.setStreet(locationJSON.get("street").toString());

			if (!locationJSON.isNull("city"))
				location.setCity(locationJSON.get("city").toString());

			if (!locationJSON.isNull("country"))
				location.setCountry(locationJSON.get("country").toString());

			if (!locationJSON.isNull("zip"))
				location.setZip(locationJSON.get("zip").toString());

			if (!locationJSON.isNull("latitude"))
				location.setLatitude(locationJSON.get("latitude").toString());
			
			if (!locationJSON.isNull("longitude"))
				location.setLongitude(locationJSON.get("longitude").toString());
		}

		

		return new Checkin(name, category, location, id);

	}
	
	public User getUser(int index) throws JSONException {
